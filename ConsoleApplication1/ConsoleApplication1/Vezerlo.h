...
public:
	...
	void vasarlas(SajtBurger s, SimaBurger si, VegaBurger v, EgyediBurger Egyedb, SultKrumpli su, Udito ud, Menu me, Szamla szamla,Hozzavalok h1,Ceg c,Naplo naplo);
	int Krumpli();
	int hamburger();
	int UditoMeret();
	int UditoFajta();
